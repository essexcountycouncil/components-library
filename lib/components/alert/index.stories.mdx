import { Meta, Story, Source, ArgsTable, Canvas } from '@storybook/addon-docs/blocks';
...
<Story name="Info" args={{
    ...
    content: 'We have been doing lots of research and you have helped us update this service.',
    type: 'info'
}}>
    {(args) => (
        <Alert {...args}>
...
<Story name="Warning" args={{
    ...
    content: 'Some schools in Essex are closed due to severe weather. Check if your child\'s school is closed',
    type: 'warning'
}}>
    {(args) => (
        <Alert {...args}>
...
<Story name="Error" args={{
    ...
    content: 'You may experience some issues with our website. Please bare with us while we resolve the issue.',
    type: 'error'
}}>
    {(args) => (
        <Alert {...args}>
