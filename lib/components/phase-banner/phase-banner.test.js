...
test('That <PhaseBanner /> can render as expected', () => {
    render(<PhaseBanner phaseTag='alpha'>This is our new website design - it&apos;s work in progress.</PhaseBanner>);
    ...
    expect(phasebannerChild).toHaveTextContent("This is our new website design - it's work in progress.");
});
