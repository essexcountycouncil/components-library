...
<StaticSource code={
    <Link href="/" title="An internal link">Internal link</Link>
} />
...
<StaticSource code={
    <Link href="/" title="An external link" target="_blank" external>A new tab</Link>
} />
...
<StaticSource code={
    <Link href="/" title="An external link" external>Same tab</Link>
} />
...
<StaticSource code={
    <Link href="/" title="An external link" download external>Download</Link>
} />
