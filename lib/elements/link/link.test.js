...
test("That the base external link has correct props", () => {
    render(
        <Link href="/" title="A test link" external>
            Test link
        </Link>
    );
    ...
    expect(
        screen.getByText("Replacing your browser tab with an external website")
    ).toBeInTheDocument();
    expect(
        screen.getByText("Replacing your browser tab with an external website")
...
test("That the new tab external link has correct props", () => {
    render(
        <Link href="/" title="A test link" external target="_blank">
            Test link
        </Link>
    );
    ...
    expect(
        screen.getByText("Opening a new tab from an external website")
    ).toBeInTheDocument();
    expect(
        screen.getByText("Opening a new tab from an external website")
    ).toHaveClass("visually-hidden");
...
test("That the download external link has correct props", () => {
    render(
        <Link href="/" title="A test link" external download>
            Test link
        </Link>
    );
    ...
    expect(
        screen.getByText("Clicking this will download or open this file")
    ).toBeInTheDocument();
    expect(
        screen.getByText("Clicking this will download or open this file")
    ).toHaveClass("visually-hidden");
