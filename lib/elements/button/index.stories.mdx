...
<StaticSource code={<Button href="financial-assessment-eligibility" type="button">Start Application</Button>} />
...
<StaticSource code={<Button type="text">Hide this message</Button>} />
...
<StaticSource code={<Button type="submit">Continue</Button>} />
